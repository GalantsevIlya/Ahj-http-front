...
class HelpDesk {
  ...
  catchesClick(e) {
    ...
    if (e.target.classList.contains("btn-ticket") && e.target.classList.contains("checkbox")) {
      this.changeStatus(e);
    }
  ...
  async changeTicket(e) {
    ...
    this.changeTickReq = this.changeTicketRequest.bind(this, form, btnCancel, btn, idTicket, ticketForm);
  ...
  deleteTicket(e) {
    ...
    this.deleteTickReq = this.deleteTicketRequest.bind(this, form, btnCancel, btn, idTicket, ticketForm);
